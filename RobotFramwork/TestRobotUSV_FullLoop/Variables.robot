...
#Survey sale All
${LinksurveySale_13}    https://s1-atv-staging.bizcuitvoc.com/SeL5b5ilo
${LinksurveySale_14}    https://s1-atv-staging.bizcuitvoc.com/VtKv$GM56
${LinksurveySale_15}    https://s1-atv-staging.bizcuitvoc.com/i8orO5o0x
${LinksurveySale_16}    https://s1-atv-staging.bizcuitvoc.com/44ILjHmM3
${LinksurveySale_17}    https://s1-atv-staging.bizcuitvoc.com/8uL2vHUnm
${LinksurveySale_18}    https://s1-atv-staging.bizcuitvoc.com/sD5$9$cTQ
${LinksurveySale_19}    https://s1-atv-staging.bizcuitvoc.com/4GRTZlDsn
${LinksurveySale_20}    https://s1-atv-staging.bizcuitvoc.com/IXDitKhnB
${LinksurveySale_21}    https://s1-atv-staging.bizcuitvoc.com/Y2fR2@fKx
${LinksurveySale_22}    https://s1-atv-staging.bizcuitvoc.com/krFzgF$fo
${LinksurveySale_23}    https://s1-atv-staging.bizcuitvoc.com/YjksBqYu9
${LinksurveySale_24}    https://s1-atv-staging.bizcuitvoc.com/vJY9Nyz@S
##
...
#Survey Service Set1
${LinksurveyService_1}    https://s1-atv-staging.bizcuitvoc.com/H8lm7V46Y
${LinksurveyService_2}    https://s1-atv-staging.bizcuitvoc.com/7FtNkUbR1
${LinksurveyService_3}    https://s1-atv-staging.bizcuitvoc.com/ekx9NcFuW
${LinksurveyService_4}    https://s1-atv-staging.bizcuitvoc.com/YW1uawdfo
${LinksurveyService_5}    https://s1-atv-staging.bizcuitvoc.com/PxKI6nqE7
${LinksurveyService_6}    https://s1-atv-staging.bizcuitvoc.com/LBvgvxPxj
${LinksurveyService_7}    https://s1-atv-staging.bizcuitvoc.com/GIhcHlExM
${LinksurveyService_8}    https://s1-atv-staging.bizcuitvoc.com/oxp2nco02
${LinksurveyService_9}    https://s1-atv-staging.bizcuitvoc.com/fZUe3SC89
${LinksurveyService_10}    https://s1-atv-staging.bizcuitvoc.com/sD7CVMY5d
${LinksurveyService_11}    https://s1-atv-staging.bizcuitvoc.com/ACvYhTKsW
${LinksurveyService_12}    https://s1-atv-staging.bizcuitvoc.com/RrAVYZ7SH
${LinksurveyService_13}    https://s1-atv-staging.bizcuitvoc.com/8AQvQdc9W
${LinksurveyService_14}    https://s1-atv-staging.bizcuitvoc.com/479Uvu3Uz
${LinksurveyService_15}    https://s1-atv-staging.bizcuitvoc.com/IN2583r7U
${LinksurveyService_16}    https://s1-atv-staging.bizcuitvoc.com/9Xe384Yrk
${LinksurveyService_17}    https://s1-atv-staging.bizcuitvoc.com/P@KxG94e9
${LinksurveyService_18}    https://s1-atv-staging.bizcuitvoc.com/7sy1PoUdh
${LinksurveyService_19}    https://s1-atv-staging.bizcuitvoc.com/SlY9JJuof
${LinksurveyService_20}    https://s1-atv-staging.bizcuitvoc.com/b2vmleMhc
${LinksurveyService_21}    https://s1-atv-staging.bizcuitvoc.com/LyvNTFYsU
${LinksurveyService_22}    https://s1-atv-staging.bizcuitvoc.com/qOqf0F7UD
${LinksurveyService_23}    https://s1-atv-staging.bizcuitvoc.com/uXeGwnlpZ
${LinksurveyService_24}    https://s1-atv-staging.bizcuitvoc.com/PKXdCLCVh
#Survey Service Set2
${LinksurveyService_25}    https://s1-atv-staging.bizcuitvoc.com/pLNsczBy1
${LinksurveyService_26}    https://s1-atv-staging.bizcuitvoc.com/U9IbJsJXb
${LinksurveyService_27}    https://s1-atv-staging.bizcuitvoc.com/L6gNZTOxG
${LinksurveyService_28}    https://s1-atv-staging.bizcuitvoc.com/jKMdLWkD2
${LinksurveyService_29}    https://s1-atv-staging.bizcuitvoc.com/B7hjAgFuX
${LinksurveyService_30}    https://s1-atv-staging.bizcuitvoc.com/Cv18r6x0z
${LinksurveyService_31}    https://s1-atv-staging.bizcuitvoc.com/Vp3Zg4pne
