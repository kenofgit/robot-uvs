...
Q1
    ...
    Element Should Contain    name=Question_3_0_0    ${Check_Q1_TH}
...
WaitingStaff
    ...
    Element Should Contain    name=Question_4_0_0    ${CheckWaitingStaff}
    Element Should Contain    name=Question_4_0_0    ${CheckWaitingStaff_1}
    Element Should Contain    name=Question_4_0_0    ${CheckWaitingStaff_2}
    Element Should Contain    name=Question_4_0_0    ${CheckWaitingStaff_3}
    Page Should Contain Element    //span[@class="btn next"][text()='ถัดไป']

Q2
    [Arguments]    ${Check_Q2_TH}
    Element Should Contain    name=Question_5_0_0    ${Check_Q2_TH}
    ...
    Element Should Contain    ${CheckChoiceQ2_7}    อื่นๆ...โปรดระบุ
    Page Should Contain Element

Q3
    [Arguments]    ${Check_Q3_TH}
    Element Should Contain    name=Question_6_0_0    ${Check_Q3_TH}
...
Q4
    ...
    Element Should Contain    name=Question_7_0_0    ${Check_Q4_TH}
...
Q5
    ...
    Element Should Contain    name=Question_8_0_0    ${Check_Q5_TH}
    Page Should Contain Element

Q6_Banana Store
    [Arguments]    ${Check_Q6_TH_BananaStore}
    Element Should Contain    name=Question_9_0_0    ${Check_Q6_TH_BananaStore}
    Page Should Contain Element

Q6_Banana Mobile
    [Arguments]    ${Check_Q6_TH_BananaMobile}
    Element Should Contain    name=Question_9_0_0    ${Check_Q6_TH_BananaMobile}
    Page Should Contain Element

Q6_Studio7
    [Arguments]    ${Check_Q6_TH_Studio7}
    Element Should Contain    name=Question_9_0_0    ${Check_Q6_TH_Studio7}
    Page Should Contain Element

Q6_UStore
    [Arguments]    ${Check_Q6_TH_UStore}
    Element Should Contain    name=Question_9_0_0    ${Check_Q6_TH_UStore}
    Page Should Contain Element

Q6_iCare
    [Arguments]    ${Check_Q6_TH_iCare}
    Element Should Contain    name=Question_9_0_0    ${Check_Q6_TH_iCare}
    Page Should Contain Element

Q7
    [Arguments]    ${Check_Q7_TH}
    Element Should Contain    name=Question_10_0_0    ${Check_Q7_TH}
    Element Should Contain    //    ${Opt_in_Q7_have}
    Element Should Contain    //    ${Opt_in_Q7_Notehave}
